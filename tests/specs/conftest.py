"""
Configuración de pytest y fixtures para tests E2E/Specs.
Incluye integración con Allure para reportería y screenshots.

Este archivo contiene:
- Fixture driver_setup para Appium
- Funciones helper para Allure (screenshots, page source)
- Hook automático para capturar evidencia en fallos
"""
...
def allure_attach_screenshot(driver, name: str = None) -> None:
    ...
    Uso en tests:
        from tests.specs.conftest import allure_attach_screenshot
...
def allure_attach_page_source(driver, name: str = None) -> None:
    ...
    Uso en tests:
        from tests.specs.conftest import allure_attach_page_source
...
def allure_attach_debug_snapshot(driver, name: str = None) -> None:
    ...
    Uso en tests:
        from tests.specs.conftest import allure_attach_debug_snapshot
